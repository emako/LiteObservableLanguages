...
using ResourceProvider = LiteObservableLanguages.Abstractions.ResourceProvider;
...
public partial class I18NExtension : MarkupExtension, IAddChild
{
    ...
    internal static event CultureChangedHandler? CultureChanged;

    internal delegate void CultureChangedHandler(CultureInfo culture);
    ...
    private static void RegisterLanguageSource(ResourceProvider provider)
    {
        ...
        provider.PropertyChanged += (_, e) => Update(e.PropertyName!);
    ...
    private MultiBinding MapMultiBinding()
    {
        ...
        ret.Converter = new MultiValueLangConverter([.. isBindingList], [.. modes])
        {
            Keys = [.. keys],
            Converter = Converter,
            ConverterParameter = ConverterParameter,
...
#pragma warning restore CS9113 // Parameter is unread.
    ...
    internal partial class ResourceChangedNotifier(INotifyPropertyChanged source) : INotifyPropertyChanged
    {
        ...
        {
            this.provider?.ChangeCompleted -= ChangeCompleted;
